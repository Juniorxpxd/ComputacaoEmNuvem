...
namespace AluguelDeCarros.DAO
{
    class EmpresaDAO
    {
        ...
        {
            return entities.Empresas.Include("Plano").Include("Cliente").FirstOrDefault(x => x.Email.Equals(Empresa.Email) && x.Senha.Equals(Empresa.Senha));
        }
        ...
        {
            return entities.Empresas.Include("Plano").Include("Cliente").FirstOrDefault(x => x.Email.Equals(Empresa.Email));
        }
        public static Empresa BuscarEmpresaPorCNPJ(Empresa Empresa)
        {
            return entities.Empresas.Include("Plano").Include("Cliente").FirstOrDefault(x => x.CNPJ.Equals(Empresa.CNPJ));
        }
        public static Empresa BuscarEmpresaPorNomeEmpresa(Empresa Empresa)
        {
            return entities.Empresas.Include("Plano").Include("Cliente").FirstOrDefault(x => x.NomeEmpresa.Equals(Empresa.NomeEmpresa));
        }
    }
}
